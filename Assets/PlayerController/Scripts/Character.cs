...
public class Character : MonoBehaviour
{
    ...
    public JoystickMovement movementInput;
    ...
    public float HorizontalSpeed
    {
        get
        {
            if (uIElements.canUseJoystick)
                return new Vector3(movementInput.leanJoystick.ScaledValue.x, 0f, movementInput.leanJoystick.ScaledValue.y).magnitude;
            else
